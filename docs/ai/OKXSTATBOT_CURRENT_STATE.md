...
- trades_since_experiment_start: 14 (+T14 AVAX/ETH r141)
- $/σ sign-flip rate: 0/5 = 0% (eligible = T2, T5, T6, T7, T8; all positive. T1, T3, T4, T9, T11, T12, T13, T14 excluded as coint-failures; T10 excluded as adverse-normal MFE<0)
- aggregate $/σ (pooled): +$0.044/σ unchanged (H1 rock-solid 5/5)
- coint-failure count (window): **8/14 = 57.1%** (T1, T3, T4, T9, T11, T12, T13, T14) — trajectory 75→60→50→37.5→44.4→50→53.8→**57.1** (last 4 trades all coint-failures; **FIRST TIME OUTSIDE historical band [36.8, 55.6]**)
- **E4 EVALUABLE: 57.1% in upper part of 45–60% REVIEW band, NOT HALT** per calibration. Now OUTSIDE historical band by 1.5pp; 4 consecutive coint-failures. **Pre-commit (template v1.4 §4) is the active reading:** T15 coint-failure → 9/15 = 60.0% AT halt line → MECHANICAL HALT; T15 normal → 8/15 = 53.3% (back in band) → trajectory was variance, continue. No deliberation at T15 close.
- adverse-normal-exits bucket: 1 (T10)
- **beta_range_observed: [0.378, 1.841]** (unchanged; T14 β=0.4562 mid-range — fills middle of distribution); β<1.0: 11/14; materially non-unity: 11/14; fallback: 0; β-sizing flawless 14/14
- cumulative PnL (experiment window): **-$4.444** (T14 -0.428; **5 LOSSES IN A ROW** T10-T14 = -$2.572). win rate 1/14 = 7.1%
...
- coint-failure mechanism: 6/8 clean β-sized DECOUPLED (T3b, T4b, T9, T11, T13, T14; T1b thin-pair TRACKED, T12 borderline TRACKED) — mean-shift signature now demonstrated at β ∈ {0.378, 0.456, 0.476, 0.561, 0.667, 1.495, 1.841} (broad coverage of the β range); refuted-lever guardrail intact (T14 entry slope -3.2e-5 essentially flat).
...
- trades_remaining: 6 (to 20 total); ≥3 more $/σ-eligible needed (5 eligible after 14 trades)
...
- audit: docs/audits/exp_beta_aware_sizing_v1_per_run_audit.md (runs 125-141, T1-T14)
