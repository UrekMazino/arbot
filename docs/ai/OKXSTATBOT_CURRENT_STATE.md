...
- trades_since_experiment_start: 3 (T1 JUP/YGG run_125, T2 LTC/KSM run_126, T3 BNB/LINK run_129)
- $/σ sign-flip rate: 0/1 = 0% (computable population = T2 only; T1 and T3 excluded as coint-failures under Rule v1.2)
- cumulative_aggregate_sigma: +$0.064/σ (positive; unchanged — T3 not in population)
- coint-failure count (window): 2/3 (T1 cointegration_lost, T3 cointegration_watch_timeout)
- beta_range_observed: [0.378, 1.495] (T3 β=0.378 lowest yet; wider than counterfactual [0.471, 1.433])
...
- audit: docs/audits/exp_beta_aware_sizing_v1_per_run_audit.md (runs 125-129, T1-T3)
