...
STATBOT_STRATEGY_KLINE_LIMIT=2880
STATBOT_STRATEGY_STARTUP_RETRY_SECONDS=5
STATBOT_STRATEGY_STARTUP_MAX_ATTEMPTS=0
STATBOT_PAIR_SUPPLY_INTERVAL_SECONDS=300
STATBOT_STRATEGY_INTERNAL_MIN_PAIRS=3
STATBOT_STRATEGY_INTERNAL_KLINE_WORKERS=2
STATBOT_PAIR_SUPPLY_RUN_IMMEDIATELY=1
STATBOT_PAIR_SUPPLY_RUN_CURATOR_AFTER_SCAN=1
STATBOT_STRATEGY_SETTLE_CCY=USDT
STATBOT_STRATEGY_MIN_EQUITY=0
STATBOT_STRATEGY_FAST_PATH=1
STATBOT_STRATEGY_CORR_MIN=0.20
STATBOT_STRATEGY_CORR_LOOKBACK=1440
...
STATBOT_STRATEGY_CORR_LOOKBACK=1440  # recent bars used for faster prefilter; 0 = full length
STATBOT_STRATEGY_TIMEFRAME=1m
STATBOT_STRATEGY_Z_SCORE_WINDOW=60
STATBOT_STRATEGY_KLINE_LIMIT=2880
```
