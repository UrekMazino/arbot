...
const SETTING_TOOLTIPS: Record<string, SettingTooltip> = {
  ...
  DISABLE_OPEN_ORDERS: { description: "Entry-only circuit breaker; when enabled, existing positions can still be managed but no new opening orders are placed", default: "0" },
  ...
  // Advanced ML shadow and live-gating settings
  ADVANCED_ML_ENABLED: { description: "Enable live advanced ML decisions. Keep disabled until shadow reports are healthy", default: "0" },
  ADVANCED_ML_SHADOW_MODE: { description: "Evaluate advanced ML decisions in shadow mode without changing execution", default: "1" },
  ADVANCED_ML_MAX_PAIRS_ACTIVE: { description: "Maximum active pairs allowed through the advanced ML live pipeline", default: "1" },
  ADVANCED_ML_EMERGENCY_DISABLE_ON_SHADOW_DIVERGENCE: { description: "Disable live advanced exits when shadow circuit breakers fail", default: "1" },
  ADVANCED_ML_MAX_SHADOW_DISAGREEMENT_RATE: { description: "Maximum acceptable old-vs-new shadow policy disagreement rate", default: "0.25" },
  ADVANCED_ML_MIN_SHADOW_POLICY_DELTA_USDT: { description: "Minimum average counterfactual USDT benefit required before live promotion", default: "0.0" },
  ADVANCED_ML_SHADOW_EVAL_WINDOW: { description: "Closed-trade shadow report window used by advanced circuit breakers", default: "50" },
  ADVANCED_ML_AUDIT_LOG_LEVEL: { description: "Audit log level for advanced ML decisions and circuit-breaker diagnostics", default: "INFO" },
  ADVANCED_ML_ROLLOUT_PHASE: { description: "Advanced ML rollout phase; 6 applies safety preconditions, 7 adds percentage rollout", default: "6" },
  ADVANCED_ML_LIVE_TRADE_PERCENTAGE: { description: "Deterministic percentage of eligible trades allowed through Phase 7 live advanced exits", default: "0.10" },
  ADVANCED_ML_ROLLOUT_REQUIRE_ELITE_OR_STABLE_PAIR: { description: "Require pair reputation to be elite or stable before live advanced soft exits", default: "1" },
  ADVANCED_ML_ROLLOUT_REQUIRE_POSITIVE_SHADOW_REPORT: { description: "Require positive post-trade shadow reports before live advanced soft exits", default: "1" },
  ADVANCED_ML_ROLLOUT_MIN_SHADOW_REPORTS: { description: "Minimum post-trade shadow reports required for Phase 6 live soft exits", default: "10" },
  ADVANCED_ML_ROLLOUT_MAX_PHASE6_BREAK_RISK: { description: "Maximum break risk accepted by Phase 6 advanced live exit preconditions", default: "0.30" },
  ADVANCED_ML_ROLLOUT_MAX_PHASE6_BOOK_AGE_MS: { description: "Maximum orderbook age accepted by Phase 6 advanced live exit preconditions", default: "1500" },
  ADVANCED_ML_ROLLOUT_MAX_PHASE6_POSITION_NOTIONAL_USDT: { description: "Maximum position notional accepted by Phase 6 advanced live exit preconditions", default: "500" },
  ADVANCED_ML_MODEL_STATE_PATH: { description: "Directory for persisted Bayesian and online-learning model state", default: "data/model_state" },
  ADVANCED_ML_MODEL_STATE_FLUSH_TICKS: { description: "Ticks between background model-state flushes", default: "50" },
  ADVANCED_ML_MODEL_STATE_FLUSH_ON_TRADE_CLOSE: { description: "Flush model state immediately after a trade closes", default: "1" },
  ADVANCED_ML_FEATURE_SCHEMA_VERSION: { description: "Feature schema version required for compatible model state loads", default: "1" },
  ADVANCED_ML_REJECT_NAN_FEATURES: { description: "Reject NaN or infinite feature vectors before model scoring", default: "1" },
  ADVANCED_ML_FINAL_SCORE_SOFT_CAP: { description: "Soft cap used to normalize final ranking scores into 0-1", default: "1.50" },
  ADVANCED_ML_MAX_BOOK_AGE_MS: { description: "Maximum orderbook age accepted by advanced microstructure checks", default: "1500" },
  ADVANCED_ML_MAX_ALLOWED_SLIPPAGE_BPS: { description: "Slippage estimate that maps to maximum advanced execution risk", default: "8.0" },
  ADVANCED_ML_EXIT_SCORE_SLIPPAGE_CAP: { description: "Cap on slippage contribution to advanced exit score while preserving raw slippage for EV", default: "0.50" },
  ADVANCED_ML_FAST_ADVERSE_THRESHOLD: { description: "Concrete threshold for classifying adverse movement as fast", default: "0.60" },
  ADVANCED_ML_WIDE_SPREAD_BPS: { description: "Concrete spread threshold in bps for wide-spread order style decisions", default: "5.0" },
  ADVANCED_ML_TARGET_EXIT_Z: { description: "Target Z-score used by the advanced hold-vs-exit EV model", default: "0.50" },
  ADVANCED_ML_EXIT_FEE_RATE: { description: "Estimated exit fee rate used by advanced EV formulas", default: "0.0006" },
  ADVANCED_ML_EXPECTED_ADVERSE_SIGMA_MOVE: { description: "Expected adverse sigma move used in the 3-outcome EV model", default: "0.50" },
  ADVANCED_ML_TIME_PENALTY_RATE_PER_HOUR: { description: "Hourly utility penalty applied while evaluating hold EV", default: "0.0001" },
  ADVANCED_ML_SPREAD_EDGE_PER_SIGMA_USDT: { description: "Fallback USDT edge estimate per sigma of favorable spread movement", default: "0.50" },
  ADVANCED_ML_EXIT_HOLD_THRESHOLD: { description: "Advanced exit score below this value keeps holding", default: "0.30" },
  ADVANCED_ML_EXIT_TIGHTEN_THRESHOLD: { description: "Advanced exit score threshold for tightening exit behavior", default: "0.55" },
  ADVANCED_ML_EXIT_PARTIAL_THRESHOLD: { description: "Advanced exit score threshold for partial-exit recommendations", default: "0.75" },
  ADVANCED_ML_MAX_HOLD_SECONDS: { description: "Maximum advanced trade hold time before hard-kill logic exits", default: "21600" },
  ADVANCED_ML_MAX_DRAWDOWN_USDT: { description: "Advanced hard-kill drawdown threshold in USDT", default: "10.0" },
  ADVANCED_ML_MIN_REGIME_PERSISTENCE_TICKS: { description: "Ticks required before accepting a new advanced regime state", default: "3" },
  ADVANCED_ML_HMM_REGIME_ENABLED: { description: "Enable optional HMM-style smoothing over heuristic regime output", default: "0" },
  ADVANCED_ML_GLOBAL_MARKET_CONTEXT_ENABLED: { description: "Enable optional global-market context overlay for advanced regime risk", default: "0" },
  ADVANCED_ML_GLOBAL_MARKET_RISK_WEIGHT: { description: "Weight applied to global-market risk when adjusting advanced break risk", default: "0.15" },
  ADVANCED_ML_REGIME_SWITCH_COOLDOWN_SECONDS: { description: "Cooldown seconds between advanced regime switches", default: "60" },
  ADVANCED_ML_REGIME_SWITCH_CONFIDENCE_MARGIN: { description: "Required confidence margin before advanced hysteresis permits a regime switch", default: "0.10" },
...
const BOT_SETTING_GROUPS: SettingGroupDefinition[] = [
  ...
  {
    id: "advanced-ml-shadow",
    title: "Advanced ML Shadow & Safety",
    description: "Shadow evaluation, circuit breakers, model state, and concrete advanced exit thresholds.",
    keys: [
      "STATBOT_ADVANCED_ML_ENABLED",
      "STATBOT_ADVANCED_ML_SHADOW_MODE",
      "STATBOT_ADVANCED_ML_MAX_PAIRS_ACTIVE",
      ...
      "STATBOT_ADVANCED_ML_SHADOW_EVAL_WINDOW",
      "STATBOT_ADVANCED_ML_AUDIT_LOG_LEVEL",
      "STATBOT_ADVANCED_ML_ROLLOUT_PHASE",
      ...
      "STATBOT_ADVANCED_ML_MODEL_STATE_PATH",
      ...
      "STATBOT_ADVANCED_ML_REJECT_NAN_FEATURES",
      "STATBOT_ADVANCED_ML_FINAL_SCORE_SOFT_CAP",
      "STATBOT_ADVANCED_ML_MAX_BOOK_AGE_MS",
      ...
      "STATBOT_ADVANCED_ML_WIDE_SPREAD_BPS",
      "STATBOT_ADVANCED_ML_TARGET_EXIT_Z",
      "STATBOT_ADVANCED_ML_EXIT_FEE_RATE",
      ...
      "STATBOT_ADVANCED_ML_EXIT_HOLD_THRESHOLD",
      "STATBOT_ADVANCED_ML_EXIT_TIGHTEN_THRESHOLD",
      "STATBOT_ADVANCED_ML_EXIT_PARTIAL_THRESHOLD",
      "STATBOT_ADVANCED_ML_MAX_HOLD_SECONDS",
      "STATBOT_ADVANCED_ML_MAX_DRAWDOWN_USDT",
...
const BOOLEAN_SETTING_KEYS = new Set<string>([
  "ADVANCED_ML_ENABLED",
  "ADVANCED_ML_EMERGENCY_DISABLE_ON_SHADOW_DIVERGENCE",
  "ADVANCED_ML_MODEL_STATE_FLUSH_ON_TRADE_CLOSE",
  "ADVANCED_ML_REJECT_NAN_FEATURES",
  "ADVANCED_ML_SHADOW_MODE",
  "BLACKLIST_ENABLED",
...
const LOG_LEVEL_OPTIONS: SettingOption[] = [
...
const SETTING_SELECT_OPTIONS: Record<string, SettingOption[]> = {
  ADVANCED_ML_AUDIT_LOG_LEVEL: LOG_LEVEL_OPTIONS,
  OKX_FLAG: [
    { label: "Demo", value: "1" },
    { label: "Live", value: "0" },
  ],
